...
class Dialog {
    fun createDealog(a1:Item,context:Context){
        ...
        btn.setOnClickListener {
            if (context is MainActivity2){
                ...
                (context as MainActivity3).updateAndroid(tt as Item2)
            }
            dialog.cancel()
        ...
        btn1.setOnClickListener {
            if (context is MainActivity2){
                ...
                (context as MainActivity3).deleteAndroid(a1 as Item2)
            }
            dialog.cancel()
        }
        layout.addView(tv1)
    ...
    fun createDealog2(a1:Item2,context:Context){
        var tv1 = EditText(context)
        var tv2 = EditText(context)
        var btn = Button(context)
        var btn1 = Button(context)
        ...
        btn.setOnClickListener {
                tt = Item2(a1.id,tv1.text.toString(),tv2.text.toString())
